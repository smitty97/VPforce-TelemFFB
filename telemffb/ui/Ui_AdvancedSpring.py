...
class Ui_AdvancedSpringDialog(object):
    ...
    def retranslateUi(self, AdvancedSpringDialog):
        ...
        self.lab_x_mastergain.setText(_translate("AdvancedSpringDialog", "X Axis Max Force:"))
        ...
        self.lab_y_mastergain.setText(_translate("AdvancedSpringDialog", "Y Axis Max Force:"))
